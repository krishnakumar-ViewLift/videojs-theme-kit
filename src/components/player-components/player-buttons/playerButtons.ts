    ...
    class SettingsButton extends Button {
        constructor(player:VideoJSPlayer, options:any={}) {
           ...
           let iconPlaceHolder = buttonElement.querySelector('.vjs-icon-placeholder')
            ...
            const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
...
export { addStartFromBeginningButton,addSettingsButton }